name=metal strips decorative wide

mipmaps=true
unlit=false

texture<0>=graphics/texture/bsp/halo/metal strips decorative wide.png
texture<1>=graphics/texture/bsp/halo/detail metal sratches.png
texture<2>=graphics/texture/bsp/halo/metal strips decorative wide bump.png
