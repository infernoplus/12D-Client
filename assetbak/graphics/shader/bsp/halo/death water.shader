...
texture<0>=graphics/texture/bsp/halo/water mask.png
...
texture<4>=graphics/texture/bsp/halo/water color.png

diffuse=((diff(texture<1,7,-7,0,0,-0.00006,-0.00008,r>,texture<2,10,-10,0,0,0.00012,0.00004,r>)+0.5)*0.33) * texture<4,5,-5,0,0,0.00012,0.00005,rgb>
