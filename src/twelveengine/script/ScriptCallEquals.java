...
public class ScriptCallEquals extends ScriptCall{
	private final String name = "Equals"; //For debugging. Just a name to identify this call by.

	public ScriptCallEquals(ScriptManager m, int c, ScriptCall a[]) {
		super(m, c, a);
	...
	public boolean executeBool() {
		return calls[0].executeString().equals(calls[1].executeString());
	}
	
	//Returns a int
	public int executeInt() {
		if(calls[0].executeString().equals(calls[1].executeString()))
			return 1;
		return 0;
	}
