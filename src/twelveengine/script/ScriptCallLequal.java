...
public class ScriptCallLequal extends ScriptCall{
	private final String name = "Lequal"; //For debugging. Just a name to identify this call by.

	public ScriptCallLequal(ScriptManager m, int c, ScriptCall a[]) {
		super(m, c, a);
