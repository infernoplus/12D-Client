...
public class ScriptCallGreater extends ScriptCall{
	private final String name = "Greater"; //For debugging. Just a name to identify this call by.

	public ScriptCallGreater(ScriptManager m, int c, ScriptCall a[]) {
		super(m, c, a);
