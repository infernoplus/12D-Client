...
public class ScriptCallLess extends ScriptCall{
	private final String name = "Less"; //For debugging. Just a name to identify this call by.

	public ScriptCallLess(ScriptManager m, int c, ScriptCall a[]) {
		super(m, c, a);
